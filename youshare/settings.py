"""
Django settings for youshare project.
...
ALLOWED_HOSTS = [
    'localhost', 
    'youshare-prod3.ap-southeast-2.elasticbeanstalk.com',
    'www.youshare.net.au']
...
WSGI_APPLICATION = 'youshare.wsgi.application'
